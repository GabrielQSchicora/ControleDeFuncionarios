...
namespace Gerenciamento_de_funcionarios.Controllers
{
    public class FuncionariosController : Controller
    {
        ...
        {
            return View(await _context.Funcionario.Include(f => f.Lotacao).ToListAsync());
        }
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var funcionario = await _context.Funcionario.Include(f => f.Lotacao)
        ...
        {
            if(funcionario.LotacaoId == 0)
            {
                funcionario.LotacaoId = null;

                ModelState.Clear();
                TryValidateModel(funcionario);
            }
